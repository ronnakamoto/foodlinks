 ...
 */
const deployFoodSafetyInsurance: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  await deploy("FoodSafetyInsurance", {
    from: deployer,
    // Contract constructor arguments
    args: [cbdcAddress, userManagementAddress],
    log: true,
...
export default deployFoodSafetyInsurance;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags YourContract
deployFoodSafetyInsurance.tags = ["FoodSafetyInsurance"];
