 ...
 */
const deployInspectionManagement: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  await deploy("InspectionManagement", {
    from: deployer,
    // Contract constructor arguments
    args: [traceabilityAddress, userManagementAddress],
    log: true,
...
export default deployInspectionManagement;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags YourContract
deployInspectionManagement.tags = ["InspectionManagement"];
